  ...
  return (
    <Link href="/" className="flex items-center gap-1.5" onClick={handleClick}>
      <div className="relative flex items-center justify-center">
        <div className="absolute inset-0 bg-yellow-400 rounded-full opacity-30 animate-pulse"></div>
        <Anchor
          className={`${variant === "footer" ? "h-6 w-6 text-yellow-400" : "h-5 w-5 text-white"} relative z-10`}
        />
      </div>
