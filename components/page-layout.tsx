...
import { BookOpen, Phone, HelpCircle, Home } from "lucide-react"
...
export default function PageLayout({ children, activeLink }: PageLayoutProps) {
  return (
              ...
              {[
                ...
                <Link
                  ...
                  className={`relative flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 hover:bg-blue-500/70 group overflow-hidden ${
                    item.name === activeLink ? "bg-blue-500/70" : ""
                  }`}
                >
