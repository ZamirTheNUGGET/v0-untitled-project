...
import { ArrowLeft, BookOpen, Phone, HelpCircle, Calendar, Clock, Tag, Home } from "lucide-react"
...
export default function BlogLayout({
  ...
  readTime,
  category,
  image = "/placeholder.svg?height=600&width=1200&text=Blog+Post",
        ...
        <article className="w-full py-12 md:py-16 lg:py-20 relative">
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-4xl">
              ...
              {/* Featured Image */}
              <div className={`bg-gradient-to-br ${color} text-white rounded-xl overflow-hidden shadow-xl mb-8`}>
